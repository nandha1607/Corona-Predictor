...
tb.add_row(["Brazil",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Finland",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Germany",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["India",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Japan",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Italy",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Kenya",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Malaysia",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Nepal",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
tb.add_row(["Ukraine",int(func(model0,daysCount+1)),int(func(model0,daysCount+2)),int(func(model0,daysCount+3)),int(func(model0,daysCount+4)),int(func(model0,daysCount+5)),int(func(model0,daysCount+6)),int(func(model0,daysCount+7)),int(func(model0,daysCount+8)),int(func(model0,daysCount+9)),int(func(model0,daysCount+10))])
